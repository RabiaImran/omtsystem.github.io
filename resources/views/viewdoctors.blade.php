<style>
    <?php include public_path('css/StyleViewDoctors.css'); ?>
</style>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <div class="main_nav_logo">
        <div class="main_nav_logo_flex">
            <div class="logo">
                <a href="#">
                    <img src="/images/img/viewdoctors/Capture1-.png" class="image-fit" alt="Care X"
                        style="height:120px; top: 1px;">
                </a>
            </div>
                        ...
                        <div id="custom_html-5" class="widget_text widget widget_custom_html">
                            ...
                            <div class="textwidget custom-html-widget">
                                ...
                                <p class="no-margin text-custom-black fs-14">
                                    ...
                                    Phone: <a href="#"
                                        class="text-custom-black_link text-custom-black fw-600">+(347)
                                        123 456 7890</a>
                                </p>
                            </div>
                        </div>
