<style>
    <?php include public_path('css/homepage.css'); ?>
</style>
<style>
    <?php include public_path('css/Running.css'); ?>
</style>
<style>
    <?php include public_path('css/bootstrap.min.css'); ?>
</style>
<style>
    <?php include public_path('css/fontawesome.min.css'); ?>
</style>
<style>
    <?php include public_path('css/all.min.css'); ?>
</style>
<style>
...
<body>
    ...
    <div class="main-wrapper">
       ...
       <img src="images/img/LOGO.png" class="img-fluid" alt="Logo"> OMT</a>  -->
                    <ul class="main-nav">
                        <nav>
                            <div class="sidebar-button">

                                <div id="typing" style="margin-left: 10px;"> <img src="images/img/LOGO.png"
                                        class="img-fluid" alt="Logo">
                                    <span>OMT Appointment System</span>
                                </div>
                                <div id="crow">|</div>
                            </div>
                        </nav>
                ...
                <div class="main-menu-wrapper">
                    <div class="menu-header">
                        <a href="index-2.html" class="menu-logo">
                            <img src="images/img/LOGO.png" class="img-fluid" alt="Logo">
                        </a>
                ...
                <ul class="nav header-navbar-rht">
                    <li class="nav-item contact-item">
                        ...
                        <div class="header-contact-detail">
                            ...
                            <p class="contact-info-header"> (021) 111 760 760</p>
                        </div>
                    </li>
                ...
                <li>
                    <ul class="nav header-navbar-rht">
                        <a href="#">
                            <i class='nav-item'>
                                <!--	<span class="nav-link header-login" id="loginbtn">login / Signup</span>  -->
                                <button class="nav-link header-login" id="loginbtn">login / Signup</button>
                            </i>


                            <!--	<li class="nav-item">
       <a class="nav-link header-login"  id="loginbtn">login / Signup </a>
      </li> -->
                        </a>
                    </ul>
                </li>
            ...
            <div class="container-fluid">
                <div class="banner-wrapper">
                    <div class="banner-header text-center">
                        <h1>Book & Consult Psychiatrist</h1>
                        <p>DISCOVER THE ONLINE APPOINTMENT!</p>
                    </div>
        ...
        <section class="section section-specialities">
            <div class="container-fluid">
                <div class="section-header text-center">
                    <h2>Specialities</h2>
                    <p class="sub-title">Doctors of Different Specialities in Karachi Psychiatric Hospital</p>
                </div>
                        ...
                        <div class="specialities-slider slider">
                            ...
                            <div class="speicality-item text-center">
                                <div class="speicality-img">
                                    <img src="images/img/specialities/SPECIALITIES-01.png" class="img-fluid"
                                        alt="Speciality">
                            ...
                            <div class="speicality-item text-center">
                                <div class="speicality-img">
                                    <img src="images/img/specialities/SPECIALITIES-02.png" class="img-fluid"
                                        alt="Speciality">
                                    <span><i class="fa fa-circle" aria-hidden="true"></i></span>
                                </div>
                                <p>Neurology</p>
                            ...
                            <div class="speicality-item text-center">
                                <div class="speicality-img">
                                    <img src="images/img/specialities/SPECIALITIES-03.png" class="img-fluid"
                                        alt="Speciality">
                                    <span><i class="fa fa-circle" aria-hidden="true"></i></span>
                                </div>
                                <p>Psychologists</p>
                            ...
                            <div class="speicality-item text-center">
                                <div class="speicality-img">
                                    <img src="images/img/specialities/SPECIALITIES-04.png" class="img-fluid"
                                        alt="Speciality">
                                    <span><i class="fa fa-circle" aria-hidden="true"></i></span>
                                </div>
                                <p>Psychotherapy</p>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-5 features-img">
                        <img src="images/img/features/Feature.png" class="img-fluid" alt="Feature">
                    </div>
                    <div class="col-md-7">
                        <div class="section-header">
                            <h2 class="mt-2">Availabe Services in Our Hospital</h2>
                            <p>Psychiatrists specialists in Karachi Psychiatric Hospital provide the best services and
                                treat issues like Autism, Cognitive Behavioral Therapy, Career Counselling, Crisis
                                Management, General Psychiatry, Resolving Mental Health Issues </p>
                        </div>

                        <div class="features-slider slider">
                            <!-- Slider Item -->
                            <div class="feature-item text-center">
                                <img src="images/img/features/Feature-01.jpg" class="img-fluid" alt="Feature">
                                <p>Mental illnesses</p>
                            </div>
                            <!-- /Slider Item -->

                            <!-- Slider Item -->
                            <div class="feature-item text-center">
                                <img src="images/img/features/Feature-02.jpg" class="img-fluid" alt="Feature">
                                <p>Spiritual</p>
                            </div>
                            <!-- /Slider Item -->
                            ...
                            <!-- Slider Item -->
                            <div class="feature-item text-center">
                                <img src="images/img/features/Feature-03.jpg" class="img-fluid" alt="Feature">
                                <p>Physical</p>
                            </div>
                            <!-- /Slider Item -->
                            ...
                            <!-- Slider Item -->
                            <div class="feature-item text-center">
                                <img src="images/img/features/Feature-04.jpg" class="img-fluid" alt="Feature">
                                <p>Drugs Disease</p>
                            </div>
                            <!-- /Slider Item -->
                            ...
                            <!-- Slider Item -->
                            <div class="feature-item text-center">
                                <img src="images/img/features/Feature-05.jpg" class="img-fluid" alt="Feature">
                                <p>Phobias</p>
                            </div>
                            <!-- /Slider Item -->
                            ...
                            <!-- Slider Item -->
                            <div class="feature-item text-center">
                                <img src="images/img/features/feature-06.jpg" class="img-fluid" alt="Feature">
                                <p>Medications</p>
                            </div>
                            <!-- /Slider Item -->
                        ...
                        <div class="col-lg-4 col-md-6">
                            ...
                            <div class="footer-widget footer-about">
                                <div class="footer-logo">
                                    <h2 class="footer-title">Online Mental Treatment</h2>
                                </div>
                                <div class="footer-about-content">
                                    <p>OMT is most trusted platform to Find, Book and Consult Doctors. It provides
                                        online video consultation, Book your appointment on one click, 12/7 best
                                        customer services, Online medicine delivery.</p>
            ...
            <li>
             <a href="#" target="_blank"><i class="fab fa-dribbble"></i> </a>
                            ...
                            <div class="footer-widget footer-contact">
                                ...
                                <div class="footer-contact-info">
                                    <div class="footer-address">
                                        ...
                                        <p>B 1, 14-B Nazimabad #3, Block 3 Nazimabad,<br> Karachi, Sindh 74600 </p>
                                    </div>
                                    <p>
                                        <i class="fa fa-phone"></i>
                                        (021) 111 760 760
                        ...
                        <div class="col-lg-2 col-md-4">
                            <p class="float-right">
                                <a href="#">
                                    <button class="nav-link header-login" id="loginbtn">TOP</button>
                                </a>
                            </p>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-lg-6">
                                <div class="copyright-text">
                                    <p class="mb-0"><a href="">© Website 2022 | All Rights Reserved</a></p>
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-6">
                                    ...
                                    <ul class="policy-menu">
                                        <li>
                                            <a href="#">
                                                ...
                                                <span class="links_name" id="term">Terms and Conditions |
                                                    Policy</span>
                                            </a>
                                        </li>
                                ...
                                return 1 === g && 0 === v ? function(e) {
                                    ...
                                    if (c) {
                                        ...
                                        if (u = [m ? c.firstChild : c.lastChild], m && p) {
                                            ...
                                            [])[0] === S && r[1]) && r[2], a = s && c.childNodes[s];
        ...
        (function(e, t) {
            ...
            function p(e) {
                ...
                return i && 'BODY' !== i && 'HTML' !== i ? -1 !== ['TH', 'TD', 'TABLE'].indexOf(n.nodeName) &&
                    'static' === t(n, 'position') ? p(n) : n : e ? e.ownerDocument.documentElement : document
                    .documentElement
            }
            ...
            function h(e, t, o, n) {
                return ee(t['offset' + e], t['scroll' + e], o['client' + e], o['offset' + e], o['scroll' + e], r(10) ?
                    parseInt(o['offset' + e]) + parseInt(n['margin' + ('Height' === e ? 'Top' : 'Left')]) +
                    parseInt(n['margin' + ('Height' === e ? 'Bottom' : 'Right')]) : 0)
            }
            ...
            function b(e, o) {
                ...
                if (b.marginTop = 0, b.marginLeft = 0, !p && s) {
                    ...
                    b.top -= h - w, b.bottom -= h - w, b.left -= c - y, b.right -= c - y, b.marginTop = w, b
                        .marginLeft = y
                }
            ...
            function k() {
                if (!this.state.isDestroyed) {
                    ...
                    e.offsets.reference = L(this.state, this.popper, this.reference, this.options.positionFixed), e
                        ...
                        .popper = D(this.popper, e.offsets.reference, e.placement), e.offsets.popper.position = this
            ...
            function B() {
                return this.state.isDestroyed = !0, W(this.modifiers, 'applyStyle') && (this.popper.removeAttribute(
                        ...
                        .willChange = '', this.popper.style[H('transform')] = ''), this.disableEventListeners(), this
            ...
            function I() {
                this.state.eventsEnabled || (this.state = F(this.reference, this.options, this.state, this
                    .scheduleUpdate))
            }
            ...
            function J(e, t) {
                var o, n = t.offset,
                    ...
                    s = r.reference,
                    d = i.split('-')[0];
                return o = Y(+n) ? [+n, 0] : X(n, p, s, d), 'left' === d ? (p.top += o[0], p.left -= o[1]) : 'right' ===
            ...
            for (var Q = Math.min, Z = Math.floor, $ = Math.round, ee = Math.max, te = 'undefined' != typeof window &&
                ...
                he = ['auto-start', 'auto', 'auto-end', 'top-start', 'top', 'top-end', 'right-start', 'right',
                    ...
                    modifiers: {
                            ...
                            fn: function(e, t) {
                                ...
                                var l = t.priority,
                                    ...
                                    m = {
                                        primary: function(e) {
                                            var o = f[e];
                                            return f[e] < a[e] && !t.escapeWithReference && (o = ee(f[e], a[
                                                e])), le({}, e, o)
                                        },
                        ...
                        arrow: {
                            ...
                            fn: function(e, o) {
                                ...
                                return v = ee(Q(s[l] - u, v), 0), e.arrowElement = i, e.offsets.arrow = (n = {}, le(
                                    n, m, $(v)), le(n, h, ''), n), e
                            },
                            element: '[x-arrow]'
                        },
                        flip: {
                            ...
                            fn: function(e, t) {
                                ...
                                return p.forEach(function(s, d) {
                                    ...
                                    (m || b || y) && (e.flipped = !0, (m || b) && (n = p[d + 1]), y && (r =
                                            z(r)), e.placement = n + (r ? '-' + r : ''), e.offsets.popper =
                                        fe({}, e.offsets.popper, D(e.instance.popper, e.offsets.reference, e
                        ...
                        computeStyle: {
                            ...
                            fn: function(e, t) {
                                ...
                                var s, d, a = void 0 === r ? t.gpuAcceleration : r,
                                    ...
                                    b = H('transform');
                                if (d = 'bottom' == c ? 'HTML' === l.nodeName ? -l.clientHeight + h.bottom : -f
                                    .height + h.bottom : h.top, s = 'right' == g ? 'HTML' === l.nodeName ? -l
                                    .clientWidth + h.right : -f.width + h.right : h.left, a && b) m[b] =
                                    'translate3d(' + s + 'px, ' + d + 'px, 0)', m[c] = 0, m[g] = 0, m.willChange =
                                    'transform';
                                else {
                                    var w = 'bottom' == c ? -1 : 1,
                                        y = 'right' == g ? -1 : 1;
                        ...
                        applyStyle: {
                            ...
                            enabled: !0,
                            fn: function(e) {
                                return j(e.instance.popper, e.styles), V(e.instance.popper, e.attributes), e
    ...
    <script>
        ...
        ! function(t, e) {
            "object" == typeof exports && "undefined" != typeof module ? e(exports, require("jquery"), require(
                    "popper.js")) : "function" == typeof define && define.amd ? define(["exports", "jquery", "popper.js"],
                    e) :
                    ...
                    return t.toggle = function() {
                        ...
                        if (n) {
                            ...
                            if (i) {
                                if ("radio" === i.type)
                                    ...
                                    ._element.classList.contains(S) && (t = !1) : t = !1;
                                t && (i.checked = !this._element.classList.contains(S), g(i).trigger("change")), i
                                    .focus(), e = !1
                            }
                        }
                        this._element.hasAttribute("disabled") || this._element.classList.contains("disabled") || (
                            e && this._element.setAttribute("aria-pressed", !this._element.classList.contains(
                                S)), t && g(this._element).toggleClass(S))
                    }, t.dispose = function() {
                ...
                ut = function() {
                    function r(t, e) {
                        this._items = null, this._interval = null, this._activeElement = null, this._isPaused = !1, this
                            ...
                            .querySelector(at), this._touchSupported = "ontouchstart" in document.documentElement || 0 <
                    ...
                    return t.next = function() {
                        ...
                        t || (this._isPaused = !0), this._element.querySelector(st) && (_.triggerTransitionEnd(this
                        ...
                        g(this._element).off(F), g.removeData(this._element, x), this._items = null, this._config =
                        ...
                        if (this._touchSupported) {
                            ...
                            g(this._element.querySelectorAll(rt)).on(Y.DRAG_START, function(t) {
                                ...
                                return i(t)
                            }), this._element.classList.add(et)) : (g(this._element).on(Y.TOUCHSTART, function(
                                t) {
                                return n(t)
                            }), g(this._element).on(Y.TOUCHMOVE, function(t) {
                                return function(t) {
                                    t.originalEvent.touches && 1 < t.originalEvent.touches.length ?
                                        e.touchDeltaX = 0 : e.touchDeltaX = t.originalEvent.touches[
                                            0].clientX - e.touchStartX
                                }(t)
                        ...
                        if (o = t === K ? (n = J, i = Z, B) : (n = G, i = tt, V), l && g(l).hasClass(X)) this
                            ._isSliding = !1;
                            ...
                            } else g(s).removeClass(X), g(l).addClass(X), this._isSliding = !1, g(this._element)
                                .trigger(u);
                            h && this.cycle()
                        }
                        ...
                        return this.each(function() {
                            ...
                            if (t || (t = new r(this, e), g(this).data(x, t)), "number" == typeof i) t.to(
                                i);
            ...
            var ft = "collapse",
                ...
                wt = function() {
                    ...
                    return t.toggle = function() {
                        ...
                        if (!this._isTransitioning && !g(this._element).hasClass(yt) && (this._parent && 0 === (
                                t = [].slice.call(this._parent.querySelectorAll(Dt)).filter(function(t) {
                                    return "string" == typeof n._config.parent ? t.getAttribute(
                                        "data-parent") === n._config.parent : t.classList.contains(Et)
                                })).length && (t = null), !(t && (e = g(t).not(this._selector).data(dt)) && e
                                ._isTransitioning))) {
                            var i = g.Event(vt.SHOW);
                            if (g(this._element).trigger(i), !i.isDefaultPrevented()) {
                                t && (a._jQueryInterface.call(g(t).not(this._selector), "hide"), e || g(t).data(dt,
                                    null));
                        ...
                        if (!this._isTransitioning && g(this._element).hasClass(yt)) {
                            ...
                            if (g(this._element).trigger(e), !e.isDefaultPrevented()) {
                                ...
                                this._element.style[n] = this._element.getBoundingClientRect()[n] + "px", _.reflow(
                                    this._element), g(this._element).addClass(Ct).removeClass(Et).removeClass(
                                    yt);
                        ...
                        g.removeData(this._element, dt), this._config = null, this._parent = null, this._element =
            ...
            var At = "dropdown",
                ...
                ee = function() {
                    ...
                    return t.toggle = function() {
                        ...
                        if (void 0 === t && (t = !1), !(this._element.disabled || g(this._element).hasClass(Ht) ||
                            ...
                            if (g(i).trigger(n), !n.isDefaultPrevented()) {
                                if (!this._inNavbar && t) {
                                    ...
                                    "parent" === this._config.reference ? o = i : _.isElement(this._config
                                        ...
                                        "scrollParent" !== this._config.boundary && g(i).addClass(qt), this
                                        ._popper = new u(o, this._menu, this._getPopperConfig())
                                }
                                "ontouchstart" in document.documentElement && 0 === g(i).closest(Bt).length && g(
                        ...
                        if (!this._element.disabled && !g(this._element).hasClass(Ht) && g(this._menu).hasClass(
                            ...
                            g(n).trigger(e), e.isDefaultPrevented() || (this._popper && this._popper.destroy(), g(
                                this._menu).toggleClass(Rt), g(n).toggleClass(Rt).trigger(g.Event(jt.HIDDEN,
                                t)))
                        }
                    }, t.dispose = function() {
                        ...
                        var t = g(this._element.parentNode),
                            e = Xt;
                        return t.hasClass(xt) ? (e = Yt, g(this._menu).hasClass(Wt) && (e = zt)) : t.hasClass(Ft) ?
                            e = Gt : t.hasClass(Ut) ? e = Jt : g(this._menu).hasClass(Wt) && (e = $t), e
                        ...
                        if (!t || 3 !== t.which && ("keyup" !== t.type || 9 === t.which))
                            for (var e = [].slice.call(document.querySelectorAll(Mt)), n = 0, i = e.length; n <
                                ...
                                if (t && "click" === t.type && (s.clickEvent = t), r) {
                                    var a = r._menu;
                                    if (g(o).hasClass(Rt) && !(t && ("click" === t.type && /input|textarea/i.test(t
                                        ...
                                        g(o).trigger(l), l.isDefaultPrevented() || ("ontouchstart" in document
                                            .documentElement && g(document.body).children().off("mouseover",
                                                null, g.noop), e[n].setAttribute("aria-expanded", "false"), r
                                            ._popper && r._popper.destroy(), g(a).removeClass(Rt), g(o)
                        ...
                        if ((/input|textarea/i.test(t.target.tagName) ? !(32 === t.which || 27 !== t.which && (
                                40 !== t.which && 38 !== t.which || g(t.target).closest(Qt).length)) : Lt.test(t
            ...
            var ne = "modal",
                ...
                Te = function() {
                    function o(t, e) {
                        this._config = this._getConfig(e), this._element = t, this._dialog = t.querySelector(me), this
                    ...
                    return t.toggle = function(t) {
                        ...
                        if (t && t.preventDefault(), this._isShown && !this._isTransitioning) {
                            ...
                            if (g(this._element).trigger(n), this._isShown && !n.isDefaultPrevented()) {
                                ...
                                if (i && (this._isTransitioning = !0), this._setEscapeEvent(), this
                                    ._setResizeEvent(), g(document).off(le.FOCUSIN), g(this._element).removeClass(
                                        ge), g(this._element).off(le.CLICK_DISMISS), g(this._dialog).off(le
                                        .MOUSEDOWN_DISMISS), i) {
                        ...
                        [window, this._element, this._dialog].forEach(function(t) {
                                return g(t).off(oe)
                            }), g(document).off(le.FOCUSIN), g.removeData(this._element, ie), this._config = null,
                        ...
                        this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE ||
                            ...
                            g(this._dialog).hasClass(ce) && i ? i.scrollTop = 0 : this._element.scrollTop = 0, n &&
                            _.reflow(this._element), g(this._element).addClass(ge), this._config.focus && this
                            ._enforceFocus();
                        ...
                        var e = this;
                        this._isShown && this._config.keyboard ? g(this._element).on(le.KEYDOWN_DISMISS, function(
                            t) {
                        ...
                        this._element.style.display = "none", this._element.setAttribute("aria-hidden", !0), this
                            ._element.removeAttribute("aria-modal"), this._isTransitioning = !1, this._showBackdrop(
                                function() {
                                    g(document.body).removeClass(fe), t._resetAdjustments(), t._resetScrollbar(), g(
                        ...
                        if (this._isShown && this._config.backdrop) {
                            if (this._backdrop = document.createElement("div"), this._backdrop.className = ue, n &&
                                this._backdrop.classList.add(n), g(this._backdrop).appendTo(document.body), g(this
                                    ._element).on(le.CLICK_DISMISS, function(t) {
                        ...
                        .call(n.body.querySelectorAll("*")), i = function(t) {
                            ...
                            i.forEach(function(t) {
                                ! function(t, e) {
                                    ...
                                    if (-1 !== e.indexOf(n)) return -1 === be.indexOf(n) || Boolean(t.nodeValue
                                        .match(De) || t.nodeValue.match(Ie));
                ...
                Xe = function() {
                    ...
                    return t.enable = function() {
                        ...
                        clearTimeout(this._timeout), g.removeData(this.element, this.constructor.DATA_KEY), g(this
                                ...
                                "hide.bs.modal", this._hideModalHandler), this.tip && g(this.tip).remove(), this
                        ...
                        if (this.isWithContent() && this._isEnabled) {
                            ...
                            g(o).data(this.constructor.DATA_KEY, this), g.contains(this.element.ownerDocument
                                    ...
                                    .constructor.Event.INSERTED), this._popper = new u(this.element, o, this
                        ...
                        function e() {
                            n._hoverState !== Fe && i.parentNode && i.parentNode.removeChild(i), n._cleanTipClass(),
                                n.element.removeAttribute("aria-describedby"), g(n.element).trigger(n.constructor
                        ...
                        if (g(this.element).trigger(o), !o.isDefaultPrevented()) {
                            if (g(i).removeClass(Me), "ontouchstart" in document.documentElement && g(document.body)
                                .children().off("mouseover", null, g.noop), this._activeTrigger[Ye] = !1, this
                                ._activeTrigger[Ve] = !1, this._activeTrigger[Be] = !1, g(this.tip).hasClass(qe)) {
                        ...
                        this.setElementContent(g(t.querySelectorAll(Ke)), this.getTitle()), g(t).removeClass(qe +
                            " " + Me)
                    }, t.setElementContent = function(t, e) {
                        "object" != typeof e || !e.nodeType && !e.jquery ? this.config.html ? (this.config
                                .sanitize && (e = we(e, this.config.whiteList, this.config.sanitizeFn)), t.html(e)
                        ...
                        this.config.trigger.split(" ").forEach(function(t) {
                                ...
                                i.element && i.hide()
                            }, g(this.element).closest(".modal").on("hide.bs.modal", this._hideModalHandler), this
                        ...
                        (e = e || g(t.currentTarget).data(n)) || (e = new this.constructor(t.currentTarget, this
                            ...
                            ._hoverState === Fe ? e._hoverState = Fe : (clearTimeout(e._timeout), e._hoverState =
                                Fe, e.config.delay && e.config.delay.show ? e._timeout = setTimeout(function() {
                        ...
                        (e = e || g(t.currentTarget).data(n)) || (e = new this.constructor(t.currentTarget, this
                            ._getDelegateConfig()), g(t.currentTarget).data(n, e)), t && (e._activeTrigger[
                            "focusout" === t.type ? Ve : Be] = !1), e._isWithActiveTrigger() || (clearTimeout(e
                                ._timeout), e._hoverState = Ue, e.config.delay && e.config.delay.hide ? e
                        ...
                        return Object.keys(e).forEach(function(t) {
                            ...
                            .content && (t.content = t.content.toString()), _.typeCheckConfig(Ae, t, this
                                .constructor.DefaultType), t.sanitize && (t.template = we(t.template, t.whiteList, t
                                .sanitizeFn)), t
                        ...
                        null === t.getAttribute("x-placement") && (g(t).removeClass(qe), this.config.animation = !1,
            ...
            var $e = "popover",
                ...
                hn = function(t) {
                    ...
                    return e.isWithContent = function() {
                        ...
                        "function" == typeof e && (e = e.call(this.element)), this.setElementContent(t.find(ln), e),
                            t.removeClass(rn + " " + sn)
                ...
                On = function() {
                    function n(t, e) {
                        ...
                        this._element = t, this._scrollElement = "BODY" === t.tagName ? window : t, this._config = this
                            ._getConfig(e), this._selector = this._config.target + " " + Tn + "," + this._config
                    ...
                    return t.refresh = function() {
                        ...
                        n.hasClass(vn) ? (n.closest(Dn).find(wn).addClass(yn), n.addClass(yn)) : (n.addClass(yn), n
                            .parents(Cn).prev(Tn + ", " + Sn).addClass(yn), n.parents(Cn).prev(bn).children(Tn)
                            .addClass(yn)), g(this._scrollElement).trigger(pn.ACTIVATE, {
                            relatedTarget: e
                        })
                    }, t._clear = function() {
                ...
                Yn = function() {
                    ...
                    return t.show = function() {
                        ...
                        if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE &&
                                g(this._element).hasClass(Rn) || g(this._element).hasClass(xn))) {
                        ...
                        var o = this,
                            r = (!e || "UL" !== e.nodeName && "OL" !== e.nodeName ? g(e).children(Mn) : g(e).find(
                                Kn))[0],
                        ...
                        if (g(t).addClass(Rn), "tab" === t.getAttribute("role") && t.setAttribute("aria-selected", !
                                0), _.reflow(t), t.classList.contains(Fn) && t.classList.add(Un), t.parentNode && g(
                                t.parentNode).hasClass(Hn)) {
                ...
                si = function() {
                    ...
                    return t.show = function() {
                        ...
                        if (g(this._element).trigger(e), !e.isDefaultPrevented()) {
                            ...
                            if (this._element.classList.remove(ti), _.reflow(this._element), this._element.classList
                        ...
                        clearTimeout(this._timeout), this._timeout = null, this._element.classList.contains(ei) &&
                            this._element.classList.remove(ei), g(this._element).off(Jn.CLICK_DISMISS), g
    ...
    <script>
        ...
        (function(factory) {
            ...
            Slick.prototype.initDotEvents = function() {
                ...
                if (_.options.dots === true && _.options.pauseOnDotsHover === true && _.slideCount > _.options
                    .slidesToShow) {
                ...
                if (_.options.centerMode === true) {
                    ...
                    if (_.options.infinite === true) {
                        ...
                        if (index >= centerOffset && index <= (_.slideCount - 1) - centerOffset) {
                            ...
                            allSlides
                                .slice(indexOffset - centerOffset + 1 + evenCoef, indexOffset + centerOffset +
                                    2)
                                .addClass('slick-active')
                                .attr('aria-hidden', 'false');
...
<script>
    const logmein = document.getElementById('loginbtn');
    logmein.addEventListener('click', event => {
        window.location = 'login';
    });

    const term2 = document.getElementById('term');
    term2.addEventListener('click', event => {
