        ...
        <div class="login-content">
            <form id="login-form">
                ...
                <div class="input-div one">
                    ...
                    <div class="input-box">
                        <input type="text" id="nic" placeholder="CNIC" pattern="[0-9+]{5}-[0-9+]{7}-[0-9]{1}"
                            title="12345-1234567-1" required>
                    </div>
                    <div class="input-box">
                        <input type="text" id="address" placeholder="Address" required>
                    </div>
                    <div class="input-box">
                        <input type="text" id="email" placeholder="Email" pattern=".+@gmail.com" size="30"
                    ...
                    <div class="input-box">
                        <input type="Password" placeholder="Password" id="fname"
                            pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}"
