...
let config = {
    appid:'57bb1a6243434f91a7ce66f586cd0d1e',
    token:'00657bb1a6243434f91a7ce66f586cd0d1eIAArnE5E49ELrvctA/+ABWWSxXfFqPTZPw4rdMVCzYENlJ1fCyoAAAAAIgCOhaHHSPjnYgQAAQBi+OdiAgBi+OdiAwBi+OdiBABi+Odi',
    uid:null,
    channel:'livestream',
}
...
let joinStreams = async () => {
    ...
    client.on("volume-indicator", function(evt){
        for (let i = 0; evt.length > i; i++){
            ...
            if(volume > 0){
                document.getElementById(`volume-${speaker}`).src = 'images/img/assets/volume-on.png'
            }else{
                document.getElementById(`volume-${speaker}`).src = 'images/img/assets/volume-off.png'
            }
